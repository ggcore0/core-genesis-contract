...
interface ICoreAgent is IAgent {
  ...
  function liquidationReward(bool claim, bool isStakeWeight, address delegator, uint256 changeRound) external returns (uint256 reward, uint256 stakedAmount1, uint256 stakedAmount2);
